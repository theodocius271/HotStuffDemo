...
const file_hotstuff_proto_rawDesc = "" +
	"\n" +
	"\x0ehotstuff.proto\x12\x05proto\x1a\fcommon.proto\"\xe9\x03\n" +
	"\x03Msg\x12*\n" +
	...
	"\aviewNum\x18\x03 \x01(\x04R\aviewNum\"e\n" +
	"\vPrepareVote\x12\x1c\n" +
	"\tblockHash\x18\x01 \x01(\fR\tblockHash\x12\x1e\n" +
	"\n" +
	...
	"\aviewNum\x18\x02 \x01(\x04R\aviewNum\"g\n" +
	...
	"\aviewNum\x18\x02 \x01(\x04R\aviewNum\"d\n" +
	"\n" +
	"CommitVote\x12\x1c\n" +
	"\tblockHash\x18\x01 \x01(\fR\tblockHash\x12\x1e\n" +
	"\n" +
	...
	"\aNewView\x12/\n" +
	"\tprepareQC\x18\x01 \x01(\v2\x11.proto.QuorumCertR\tprepareQC\x12\x18\n" +
	"\aviewNum\x18\x02 \x01(\x04R\aviewNum\"\x1b\n" +
	"\aRequest\x12\x10\n" +
	"\x03cmd\x18\x01 \x01(\tR\x03cmd\"9\n" +
	"\x05Reply\x12\x16\n" +
	...
	".proto.Msg\x1a\f.proto.Empty\"\x00\x12'\n" +
	"\tSendReply\x12\n" +
	".proto.Msg\x1a\f.proto.Empty\"\x00B'Z%/home/test/Desktop/HotStuffDemo/protob\x06proto3"
...
var file_hotstuff_proto_depIdxs = []int32{
	...
	13, // 13: proto.Commit.preCommitQC:type_name -> proto.QuorumCert
	13, // 14: proto.Decide.commitQC:type_name -> proto.QuorumCert
	13, // 15: proto.NewView.prepareQC:type_name -> proto.QuorumCert
	0,  // 16: proto.HotStuffService.SendMsg:input_type -> proto.Msg
	0,  // 17: proto.HotStuffService.SendRequest:input_type -> proto.Msg
	0,  // 18: proto.HotStuffService.SendReply:input_type -> proto.Msg
	1,  // 19: proto.HotStuffService.SendMsg:output_type -> proto.Empty
	1,  // 20: proto.HotStuffService.SendRequest:output_type -> proto.Empty
	1,  // 21: proto.HotStuffService.SendReply:output_type -> proto.Empty
